...
const routes = [{
        ...
        children: [
            ...
            {
                path: 'blacklist',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_operation_blacklist__index_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./blacklist/blacklist.module */ 73623))
