...
OversightComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: OversightComponent, selectors: [["ngx-oversight"]], decls: 26, vars: 0, consts: [[1, "text-center"], [1, "form-group"], ["nbButton", "", "fullWidth", "", "status", "basic", "disabled", "", "size", "large", 1, "form-control"], ["nbButton", "", "fullWidth", "", "status", "success", "size", "large", 1, "form-control", "form-group"]], template: function OversightComponent_Template(rf, ctx) { if (rf & 1) {
