(function () {
  ...
  (self["webpackChunkngx_admin"] = self["webpackChunkngx_admin"] || []).push([["src_app_pages_operation_register-pass__index_ts-src_app_pages_operation_register-pass_registe-b801a0"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function RegisterpassComponent_nb_select_19_nb_option_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function RegisterpassComponent_nb_select_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function RegisterpassComponent_nb_select_22_nb_option_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nb-option", 25);
      ...
      function RegisterpassComponent_nb_select_22_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nb-select", 23);
      ...
      function RegisterpassComponent_nb_select_25_nb_option_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nb-option", 25);
      ...
      function RegisterpassComponent_nb_select_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nb-select", 23);
      ...
      function RegisterpassComponent_nb_select_47_nb_option_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nb-option", 25);
      ...
      function RegisterpassComponent_nb_select_47_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nb-select", 23);
        ...
        _createClass(_RegisterpassComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.service.save(this.form.value).subscribe(function () {
              ...
              _this.toastrService.success('', 'Concluido com Sucesso');
          ...
          key: "validTab",
          value: function validTab() {
            if (this.uf.valid && this.direction.valid && this.ufDestiny.valid && this.regress.valid) {
          ...
          value: function createForm() {
            this.form = this.fb.group({
              ...
              direction: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required]),
              ...
              ufCar: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required]),
      ...
      _RegisterpassComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        viewQuery: function RegisterpassComponent_Query(rf, ctx) {
          if (rf & 1) {
        ...
        template: function RegisterpassComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](35, "N\xE3o");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](52, "Observa\xE7\xF5es:");
